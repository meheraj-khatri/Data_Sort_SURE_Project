...
Python script to integrate four disparate datasets from ACM, IEEE, Springer, and Web of Science.
Automated the merging, deduplication, and cleaning of records to create unified research repositories for Computer Science and Marketing.
